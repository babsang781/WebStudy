...
<%@page import="com.message.service.MessageDAO"%>
...
<body>
 ...
 %> <a href="update.jsp">개인정보수정</a> <a href="logout.jsp">로그아웃</a> <%
 }
 %> </nav> </header>
		...
		<div class="inner">
			<header class="major"> <!-- 로그인 후 로그인 한 사용자의 세션아이디로 바꾸시오.
									 ex)smart님 환영합니다 --> <%
 if (member == null) {
 	out.print("<h2>로그인을 해주세요</h2>");
 } else {
 	out.print(member.getM_email() + "님 환영합니다.");
 }
 %> </header>
			<div class="content">
				<p>
					...
					if(member == null){
						...
						if (msglist.isEmpty()) {
							...
							for (int i = 0; i < msglist.size(); i++) {
								out.print("<li>");
								out.print("<p>보낸사람:" + msglist.get(i).getM_sendName() + "</p>");
								out.print("<p>내용:" + msglist.get(i).getM_content() + "</p>");
								out.print("<p>날짜:" + msglist.get(i).getM_sendDate() + "</p>");
								out.print("</li>");
							}
							out.print("<li><a href='#' class='button next scrolly'>전체삭제하기</a></li>");
						}
					}
